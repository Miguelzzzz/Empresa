...
<head>
    ...
    <link rel="stylesheet" href="../css/consulta.css"> </head>
<body>
<?php include_once '../layout/header.php';?>
<main>
        <div class="const_table"><br>
            <h2>Dados dos Departamento</h2><br><br>
            <table>
                <thead>
                    <tr>
                        <th>&nbsp # &nbsp</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>&nbsp 
                            ...
                            <a class='btn btn-sm btn-danger' href="#" onclick="excluirDepartamento(<?php echo $departamento['codDepartamento']; ?>)">
                                <svg class='bootstrap-icons' xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' viewBox='0 0 16 16'>
